...
print("=== Fixing SnipeX App Icon Sizes ===")
...
// Generate icons with CORRECT sizes
...
print("All icons now have the correct dimensions for macOS.")
print("Build the app again to see the updated icons without warnings.")